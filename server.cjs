...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Environmental Justice Case Tracker";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "environmental_case";
process.env.TABLE_NAME = process.env.TABLE_NAME || "environmental_case_records";
'use strict';
